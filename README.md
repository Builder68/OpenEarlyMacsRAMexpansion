...
| Part description      | Quantity    | Supplier     | Notes           |
|:---------------------:|:-----------:|:------------:|:---------------:|
|Conn Socket 64P        |2            | [316-93-164-41-007000](https://www.digikey.com/en/products/detail/mill-max-manufacturing-corp/316-93-164-41-007000/357031?s=N4IgTCBcDaIMwEYBsBaAnHFyAsLsJQAZCB2YwkAXQF8g)| Standoff Height = 12 mm             |
...
Then, solder one end of a bodged cable of at least 5 cm long, to the pin hole where the left leg was connected. You need to do this as a first step because the expansion boards will later be on top of this connection point.
